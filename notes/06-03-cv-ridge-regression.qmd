...
Next, we will write a function that will use matrix algebra to compute the ridge regression coefficients given inputs of the training data and the $\lambda$ value.
...
- `standardize=` This is also either TRUE or FALSE depending on whether you want
