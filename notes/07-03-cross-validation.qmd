...
- [[R Script File]](https://raw.githubusercontent.com/zief0002/redesigned-adventure/main/scripts/07-03-cross-validation.R)
...
tab_01[1, 2] = cell_spec(tab_01[1, 2], bold = T, background = "#eeff41")
...
tab_02[1, 2] = cell_spec(tab_02[1, 2], bold = T, background = "#eeff41")
tab_02[3, 3] = cell_spec(tab_02[3, 3], bold = T, background = "#eeff41")
...
tab_03[1, 2] = cell_spec(tab_03[1, 2], bold = T, background = "#eeff41")
tab_03[3, 3] = cell_spec(tab_03[3, 3], bold = T, background = "#eeff41")
tab_03[3, 4] = cell_spec(tab_03[3, 4], bold = T, background = "#eeff41")
