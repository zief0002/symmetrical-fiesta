...
Unfortunately, in practice we do not know $\sigma_\epsilon$ to compute **V**. Instead, we substitute in the estimate for this value from our sample, the unbiased estimator $s_e^2$, where,
